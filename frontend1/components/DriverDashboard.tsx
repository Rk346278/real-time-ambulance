...
interface DriverDashboardProps {
    onBack: () => void;
    onSelectRoute: (route: any) => void; // NOW USED ONLY IN START LIVE TRACKING
}
...
export const DriverDashboard: React.FC<DriverDashboardProps> = ({
    ...
    const startTracking = () => {
        ...
        // ⭐ NAVIGATION HAPPENS HERE (NOT IN CHOOSE ROUTE)
        onSelectRoute(selectedRoute);

        // ⭐ LIVE TRACKING WITH SELECTED ROUTE
        startLiveTracking({
            driverName,
            ambulanceNumber,
            from: fromLocation,
    ...
    return (
        <div className="max-w-2xl mx-auto bg-gray-800 p-8 rounded-xl">
            ...
            <h2 className="text-3xl font-bold text-white text-center mb-6">Driver Dashboard</h2>
                ...
                <div className="mt-6 space-y-4">
                    ...
                    {routeOptions.map(opt => (
                        <div key={opt.index} className="p-4 bg-gray-700 rounded">
                            ...
                            <button
                                onClick={() => {
                                    setSelectedRoute(opt);   // ⭐ STORE ROUTE ONLY
                                }}
